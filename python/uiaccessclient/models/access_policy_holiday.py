...
class AccessPolicyHoliday(BaseModel):
    """
    AccessPolicyHoliday
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the holiday.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessPolicyHoliday from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessPolicyHoliday from a dict"""
        if obj is None:
            return None
