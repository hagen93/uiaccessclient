...
class UniFiIdentityApi:
    ...
    def assign_user_group_resources(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UniFiIdentityResourcesResponse",
        }
    ...
    def assign_user_group_resources_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UniFiIdentityResourcesResponse]:
        """10.5 Assign Resources to User Groups
    ...
    def _assign_user_group_resources_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/user_groups/{id}/identity/assignments',
    ...
    def _assign_user_resources_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/users/{id}/identity/assignments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _fetch_available_resources_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/users/identity/assignments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def send_unifi_identity_invitations(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UniFiIdentityInvitationStatusResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def send_unifi_identity_invitations_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UniFiIdentityInvitationStatusResponse]:
        """10.1 Send Unifi Identity Invitations
    ...
    def _send_unifi_identity_invitations_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/users/identity/invitations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
